...
class SanitizeAndGradeTranscriptUseCase @Inject constructor(private val voiceAnswerGradingRepository: VoiceAnswerGradingRepository) :
    UseCase<SanitizeAndGradeTranscriptUseCase.Params, Result<VoiceAnswerGrade>> {

    data class Params(val question: String, val expectedAnswer: String, val rawTranscript: String)
