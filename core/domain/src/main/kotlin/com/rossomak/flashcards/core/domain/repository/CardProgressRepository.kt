 ...
 * Category Details' and the Home screen's progress rings (spec 06). Both live in `core:domain` rather
 ...
 * `submitStudySession` Cloud Function (spec 08) is the sole writer of both documents, inside its own
