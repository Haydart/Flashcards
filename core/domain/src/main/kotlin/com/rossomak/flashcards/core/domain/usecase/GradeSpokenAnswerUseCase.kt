...
class GradeSpokenAnswerUseCase @Inject constructor(private val voiceAnswerGradingRepository: VoiceAnswerGradingRepository) :
    UseCase<GradeSpokenAnswerUseCase.Params, Result<VoiceAnswerGrade>> {

    data class Params(val cardId: String, val question: String, val expectedAnswer: String, val obfuscatedAnswerWav: ByteArray)
