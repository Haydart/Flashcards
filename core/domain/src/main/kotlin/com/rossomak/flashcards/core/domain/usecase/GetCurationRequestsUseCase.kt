...
class GetCurationRequestsUseCase @Inject constructor(private val curationRepository: CurationRepository) :
    UseCase<List<String>, Result<Map<String, CurationRequest>>> {

    override suspend fun invoke(params: List<String>): Result<Map<String, CurationRequest>> = curationRepository.getCurationRequests(params)
}
