 ...
 * (spec 08), which becomes the sole writer of the session's XP, level and progress —
 ...
 * own optimistic preview is never reconciled against what the function actually computed (spec 08's
 * "Reconciliation" section: deliberately none — every other screen just reads the same documents the
 ...
 *
 * Ticket 03 wraps this behind a durable, WorkManager-backed retry queue so an offline or killed-app
