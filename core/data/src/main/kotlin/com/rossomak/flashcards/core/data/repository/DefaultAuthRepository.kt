...
class DefaultAuthRepository @Inject constructor(private val remoteDataSource: AuthRemoteDataSource) : AuthRepository {

    override fun getCurrentUser(): AuthUser? = remoteDataSource.getCurrentUser()

    override suspend fun signInWithGoogleIdToken(idToken: String): Result<AuthUser> = remoteDataSource.signInWithGoogleIdToken(idToken)
